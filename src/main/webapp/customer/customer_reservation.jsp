        ...
        <form action="seat.reservation" method="post">
           <tr>
                ...
                <td align="center" colspan=1><select name="reservation">
                      <option align ="center">선택</option>
                        <option value="1" align ="center" name ="movie">서울의 봄</option>
                        <option value="2" align ="center" name ="movie">노량</option>
                        <option value="3" align ="center" name ="movie">짱구는 못말려</option>
                </select></td>
           </tr> 
           </tr>
                <tr>
                ...
                <td align="center" colspan=1><select name="Time">
                      <option align ="center">선택</option>
                        <option value="1" align ="center" name ="time">10:30~12:00</option>
                        <option value="2" align ="center" name ="time">13:30~15:00</option>
                        <option value="3" align ="center" name ="time">18:00~19:30</option>
